...
*/
    ...
    var File_Name = 'jekyll-levert.zip';
    var CSS_Files = [
    ...
    './dist/production/assets/js/masonry.pkgd.min.js', 
    './dist/production/assets/js/tsparticles.min.js', 
    './dist/production/assets/js/jquery.particles.min.js', 
    './dist/production/assets/js/pathseg.js',  
    './dist/production/assets/js/infinite-scroll.min.js',   
    './dist/production/assets/js/jekyll-search.js',   
